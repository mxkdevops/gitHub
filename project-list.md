...
AI: NLP-based classifier for tag suggestions.
...
Stack: Python + AWS Cost Explorer API + Streamlit
...
AI: Categorize attacks (botnet, brute-force, targeted)
